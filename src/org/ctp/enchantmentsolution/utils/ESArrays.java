...
public class ESArrays {
	...
	private static List<String> BAD_POTIONS = Arrays.asList("BAD_OMEN", "BLINDNESS", "CONFUSION", "HARM", "HUNGER", "POISON", "SLOW", "SLOW_DIGGING", "UNLUCK", "LEVITATION", "WEAKNESS", "WITHER");
